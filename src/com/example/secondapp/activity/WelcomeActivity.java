...
//                }
   ...
   private void login(String mobile, String pwr){
                ...
                case 123:
                    if(com.example.secondapp.bean.Response.code == 200 && object != null){
                        if(object != null){
                            ...
                            save("is_login", "1");
                            System.out.println("求跳转了没！！！！！！！！！！！");
                            Intent intent = new Intent(WelcomeActivity.this, MainActivity.class);
                            startActivity(intent);
                            finish();
                        }else {
                        	System.out.println("else了没！！！！！！！！！！！");
                            Intent intent = new Intent(WelcomeActivity.this, MainActivity.class);
                            startActivity(intent);
                            finish();
                        }
    ...
    private void init() {
        ...
        mLocationManagerProxy.requestLocationData(LocationProviderProxy.AMapNetwork, 60 * 10000, 15, this);
    ...
    public void onLocationChanged(AMapLocation amapLocation) {
        ...
        if (amapLocation != null && amapLocation.getAMapException().getErrorCode() == 0) {
            ...
            save("cityid", amapLocation.getCityCode());
            save("city", amapLocation.getCity());
         // 启动一个线程
